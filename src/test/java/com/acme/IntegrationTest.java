...
public class IntegrationTest {
    ...
    @ClassRule
    public static final DropwizardAppRule<DropwizardAppConfiguration> RULE = new DropwizardAppRule<DropwizardAppConfiguration>(
            DropwizardApp.class, CONFIG_PATH,
